    ...
    <div className='container project' id='projects'>
      {
        ...
        :
        <>
        <div className='project__round'></div>
        <h2 className='project__round-title'>РЕАЛИЗОВАННЫЕ ПРОЕКТЫ</h2>
        </>
      }
      <ul className='project__list'>
          ...
          <li className='project__item'>
            ...
            <p className='project__subtitle'></p>
            <a className='project__link' href='https://dpo.emiit.ru/' target='_blank' rel='noreferrer'>На портал ДПО</a>
          </li>
          <li className='project__item'>
